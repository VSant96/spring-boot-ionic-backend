...
import com.victor.cursomc.domain.Estado;
...
import com.victor.cursomc.domain.PagamentoComCartao;
...
import com.victor.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException 
	{
		...
		Produto p10 = new Produto(null,"Pedente",180);
		...
		Cliente cli2 = new Cliente(null,"Victor Silva", "victorsb.02@gmail.com","57153953051",TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("98855874"));
